...
from datasets.utils import class2angle
...
def extract_dets_from_outputs(outputs, K=50, topk=50):
    ...
    # print(outputs['pred_depth'].shape)
    # print(outputs['pred_angle'].shape)
    # print(outputs['pred_3d_dim'].shape)
