...
from helpers.decode_helper import extract_dets_from_outputs
from helpers.decode_helper import decode_detections
import time


class Tester(object):
    def __init__(self, cfg, model, dataloader, logger, train_cfg=None, model_name='intermdetr_V1'):
        self.cfg = cfg
        self.model = model
