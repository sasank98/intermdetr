...
from intermdetr.ops.modules import MSDeformAttn
...
class Transformer3D(nn.Module):
    def __init__(
        ...
        self.decoder = DeformableDecoder(decoder_layer, num_decoder_layers, return_intermediate_dec)
...
class DeformableDecoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        #                              depth_pos_embed,
        #                              depth_pos_embed,
        #                              key_padding_mask=mask_depth)[0].transpose(0, 1)#######3######
